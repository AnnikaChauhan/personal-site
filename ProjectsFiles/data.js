const projects = [
    ...
    },
    {
        ...
        languages: ["HTML", " CSS", " SASS", " JavaScript", " TypeScript", " Angular"," Firebase"],
    ...
    },
    {
        ...
        weekProduced: 9,
        description: "A personal interest project, built entirely alone. A React App where individuals can login to their account (or signup) using Firebase auth, read blogs by users (get from firestore), post short blogs about their own travels (post to firestore) and search cities to find weather and local attractions in that city (two APIs). Access to Trello board for feature list is available on the GitHub, additionally a list of tested components.",
    ...
    },
    {
        ...
        languages: ["HTML", " CSS", " SASS", " JavaScript", " OOP"," React"," Firebase", " Getting from Firestore"],
    ...
    },
    {
        ...
        languages: ["HTML", " CSS", " SASS", " JavaScript"," jQuery", " OOP"],
        launchLink: "",
    ...
    },
    {
        ...
        languages: ["HTML", " CSS", " SASS", " JavaScript", " basic TypeScript"],
