        ...
        box[i].onclick = () => {
            if (box[i].innerHTML === '') {
                ...
                if (box[0].innerHTML === 'X' && box[1].innerHTML === 'X' && box[2].innerHTML === 'X' || box[3].innerHTML === 'X' && box[4].innerHTML === 'X' && box[5].innerHTML === 'X' || box[6].innerHTML === 'X' && box[7].innerHTML === 'X' && box[8].innerHTML === 'X' || box[0].innerHTML === 'X' && box[3].innerHTML === 'X' && box[6].innerHTML === 'X' || box[1].innerHTML === 'X' && box[4].innerHTML === 'X' && box[7].innerHTML === 'X' || box[2].innerHTML === 'X' && box[5].innerHTML === 'X' && box[8].innerHTML === 'X' || box[0].innerHTML === 'X' && box[4].innerHTML === 'X' && box[8].innerHTML === 'X' || box[2].innerHTML === 'X' && box[4].innerHTML === 'X' && box[6].innerHTML === 'X') {
                    ...
                    number = 0;
                } else if (box[0].innerHTML === 'O' && box[1].innerHTML === 'X' && box[2].innerHTML === 'O' || box[3].innerHTML === 'O' && box[4].innerHTML === 'O' && box[5].innerHTML === 'O' || box[6].innerHTML === 'O' && box[7].innerHTML === 'O' && box[8].innerHTML === 'O' || box[0].innerHTML === 'O' && box[3].innerHTML === 'O' && box[6].innerHTML === 'O' || box[1].innerHTML === 'O' && box[4].innerHTML === 'O' && box[7].innerHTML === 'O' || box[2].innerHTML === 'O' && box[5].innerHTML === 'O' && box[8].innerHTML === 'O' || box[0].innerHTML === 'O' && box[4].innerHTML === 'O' && box[8].innerHTML === 'O' || box[2].innerHTML === 'O' && box[4].innerHTML === 'O' && box[6].innerHTML === 'O') {
                    alert('player 2 wins');
